...
import com.yaoyou.model.dataObject.OrderExample.Criteria;
import com.yaoyou.model.dataObject.OrderExample.Criterion;
...
public class OrderSqlProvider {
    ...
    public String insertSelective(Order record) {
        ...
        if (record.getPayId() != null) {
            sql.VALUES("PAY_ID", "#{payId,jdbcType=INTEGER}");
        }
        
        if (record.getAddId() != null) {
            sql.VALUES("ADD_ID", "#{addId,jdbcType=INTEGER}");
        }
        
        if (record.getDistributionId() != null) {
            sql.VALUES("DISTRIBUTION_ID", "#{distributionId,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPayId() != null) {
            sql.SET("PAY_ID = #{record.payId,jdbcType=INTEGER}");
        }
        
        if (record.getAddId() != null) {
            sql.SET("ADD_ID = #{record.addId,jdbcType=INTEGER}");
        }
        
        if (record.getDistributionId() != null) {
            sql.SET("DISTRIBUTION_ID = #{record.distributionId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Order record) {
        ...
        if (record.getPayId() != null) {
            sql.SET("PAY_ID = #{payId,jdbcType=INTEGER}");
        }
        
        if (record.getAddId() != null) {
            sql.SET("ADD_ID = #{addId,jdbcType=INTEGER}");
        }
        
        if (record.getDistributionId() != null) {
            sql.SET("DISTRIBUTION_ID = #{distributionId,jdbcType=INTEGER}");
        }
