...
import com.yaoyou.model.dataObject.NewsExample.Criteria;
import com.yaoyou.model.dataObject.NewsExample.Criterion;
...
public class NewsSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getNewsId() != null) {
            sql.SET("NEWS_ID = #{record.newsId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(News record) {
        ...
        sql.WHERE("NEWS_ID = #{newsId,jdbcType=INTEGER}");
